 ...
 * - "/" es como la autopista principal
 * - "/about" es como una calle secundaria
 * - Cada ruta lleva a un destino (componente)
 *
 * PALABRAS CLAVE:
...
// Routes: Tipo de Angular que define las rutas de la aplicación
import { Routes } from '@angular/router';

// Exporta las rutas de la aplicación
// Array vacío significa que no hay rutas definidas todavía

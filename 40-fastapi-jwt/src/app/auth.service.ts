/**
 * ARCHIVO: auth.service.ts - Servicio de autenticación JWT (FastAPI)
 *
...
// tap: Operador de RxJS que ejecuta un efecto secundario sin modificar el dato.
...
export class AuthService {
  // URL base de la API de autenticación en el backend (FastAPI/Python).
  ...
  constructor(private http: HttpClient) {
    // Verificamos si el usuario ya tenía un token guardado (ej: al recargar la página).
   ...
   *
   * Los tokens JWT tienen un tiempo de vida limitado. Cuando están por expirar,
   * enviamos el refreshToken al servidor para obtener un nuevo token.
   */

/**
 * ARCHIVO: main.ts - Punto de entrada de la aplicación Angular (Feature Flags)
 *
 ...
 *
 * En este ejemplo, la aplicación demuestra cómo implementar Feature Flags:
 * una técnica que permite activar o desactivar funcionalidades de la aplicación
 * sin necesidad de hacer un nuevo deploy.
 */
